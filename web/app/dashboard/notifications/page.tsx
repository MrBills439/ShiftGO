...
const TYPE_MAP: Record<string, { icon: React.ElementType; bg: string; color: string }> = {
  ...
  SHIFT_OPEN:          { icon: CalendarBlankIcon, bg: 'bg-[#e3f0f8]', color: 'text-[#1a6b8a]' },
  SHIFT_DROPPED:       { icon: CalendarBlankIcon, bg: 'bg-[#fff8e1]', color: 'text-[#784a00]' },
  SHIFT_CLAIMED_YOU:   { icon: CheckCircleIcon,   bg: 'bg-[#e6f4f0]', color: 'text-primary' },
  SHIFT_CLAIMED_OTHER: { icon: CalendarBlankIcon, bg: 'bg-surface-high', color: 'text-on-surface-variant' },
